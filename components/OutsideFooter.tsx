...
export default function OutsideFooter({
  address,
  phone,
  brandName,
  email,
  ...
  const footerLinks = {
    company: [
      { name: "الرئيسية", href: "/outside-saudi/#home" },
      { name: "عن الشركة", href: "/outside-saudi/#about" },
      { href: "/articles", name: "خدمات الضيافة" },
      { name: "خدماتنا", href: "/outside-saudi/#services" },
      { name: "اتصل بنا", href: "/outside-saudi/#contact" },
    ],
  };
